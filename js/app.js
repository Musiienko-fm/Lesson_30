(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".testemonials__slider")) new core(".testemonials__slider", {
            ...
            loop: true,
            navigation: {
                prevEl: ".testemonials__arrow_left",
                nextEl: ".testemonials__arrow_right"
            },
            on: {}
        });
